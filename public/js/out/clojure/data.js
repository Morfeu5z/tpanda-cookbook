...
return cljs.core.reduce.call(null,(function (result,p__24550){
...
var vec__24554 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__24554,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__24554,(1),null);
var ab = cljs.core.nth.call(null,vec__24554,(2),null);
...
var clojure$data$EqualityPartition$equality_partition$dyn_24560 = (function (x){
...
return clojure$data$EqualityPartition$equality_partition$dyn_24560.call(null,x);
}
});
...
var clojure$data$Diff$diff_similar$dyn_24561 = (function (a,b){
...
return clojure$data$Diff$diff_similar$dyn_24561.call(null,a,b);
}
});
...
return (function (){var G__24565 = clojure.data.equality_partition.call(null,a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__24565__$1)].join('')));
...
//# sourceMappingURL=data.js.map?rel=1595490054459
