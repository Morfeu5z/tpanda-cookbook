...
var file = cljs.core.get.call(null,map__25524__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__25524__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__25524__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e25523){var _e = e25523;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___25526 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5733__auto___25526)){
var seen_errors_25527 = temp__5733__auto___25526;
if(cljs.core.truth_(seen_errors_25527.has(self))){
} else {
seen_errors_25527.add(self);

var temp__5735__auto___25528 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5735__auto___25528)){
var sense_25529 = temp__5735__auto___25528;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_25529)].join(''));
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1595490056079
