...
var o23045 = temp__5733__auto__;
var temp__5733__auto____$1 = (o23045["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o23046 = temp__5733__auto____$1;
return (o23046["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__22403__auto__ = f;
return (o__22403__auto__["toString"]).call(o__22403__auto__);
} else {
return "";
}
}catch (e23047){var _ = e23047;
return "";
}});
...
try{var o__22403__auto___23049 = t;
(o__22403__auto___23049["cljs$lang$ctorPrWriter"]).call(o__22403__auto___23049,t,writer);
}catch (e23048){var __23050 = e23048;
}
...
var char_code = (function (){var o__22403__auto__ = (new String(char$));
return (o__22403__auto__["charCodeAt"]).call(o__22403__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__22403__auto__ = String;
return (o__22403__auto__["fromCharCode"]).call(o__22403__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__23051 = num_code;
switch (G__23051) {
case (1):
return (185);
...
var o__22403__auto__ = String;
return (o__22403__auto__["fromCharCode"]).call(o__22403__auto__,superscript_code);
});
/**
...
}catch (e23053){var _e__22410__auto__ = e23053;
return false;
}})())){
...
var vec__23054 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__23054,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o23057 = temp__5733__auto__;
var temp__5733__auto____$1 = (o23057["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o23058 = temp__5733__auto____$1;
return (o23058["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4736__auto___23065 = arguments.length;
var i__4737__auto___23066 = (0);
while(true){
if((i__4737__auto___23066 < len__4736__auto___23065)){
args__4742__auto__.push((arguments[i__4737__auto___23066]));

var G__23067 = (i__4737__auto___23066 + (1));
i__4737__auto___23066 = G__23067;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__23061){
var vec__23062 = p__23061;
var ns_detector = cljs.core.nth.call(null,vec__23062,(0),null);
...
var G__23068 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__23069 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__23068;
remaining_tokens = G__23069;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq23059){
var G__23060 = cljs.core.first.call(null,seq23059);
var seq23059__$1 = cljs.core.next.call(null,seq23059);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23060,seq23059__$1);
}));
...
var vec__23073 = cljs.core.split_with.call(null,(function (p1__23072_SHARP_){
return cljs.core.not_EQ_.call(null,p1__23072_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__23073,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__23073,(1),null);
...
var vec__23079 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__23079,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__23079,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__23082 = cljs.core.rest.call(null,remaining_tokens);
var G__23083 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__23082;
name_tokens = G__23083;
continue;
} else {
...
var vec__23086 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__23086,(0),null);
var arity = cljs.core.nth.call(null,vec__23086,(1),null);
var vec__23089 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__23089,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__23089,(1),null);
var vec__23092 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__23092,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__23092,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__23092,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__23092,(3),null);
...
var vec__23098 = result;
var munged_ns = cljs.core.nth.call(null,vec__23098,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__23098,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__23098,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__23098,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__23098,(4),null);
var arity = cljs.core.nth.call(null,vec__23098,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__23102 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__23102,(0),null);
var args = cljs.core.nth.call(null,vec__23102,(1),null);
var vec__23105 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__23105,(0),null);
var name = cljs.core.nth.call(null,vec__23105,(1),null);
...
var G__23108 = (arity + (1));
var G__23109 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__23110){
var vec__23111 = p__23110;
var arity = cljs.core.nth.call(null,vec__23111,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__23111,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__23114_SHARP_){
return cljs.core.get.call(null,arities,p1__23114_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__23115_SHARP_){
return cljs.core.drop.call(null,(2),p1__23115_SHARP_);
}),sorted_infos);
...
var args__4742__auto__ = [];
var len__4736__auto___23122 = arguments.length;
var i__4737__auto___23123 = (0);
while(true){
if((i__4737__auto___23123 < len__4736__auto___23122)){
args__4742__auto__.push((arguments[i__4737__auto___23123]));

var G__23124 = (i__4737__auto___23123 + (1));
i__4737__auto___23123 = G__23124;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__23118){
var vec__23119 = p__23118;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__23119,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq23116){
var G__23117 = cljs.core.first.call(null,seq23116);
var seq23116__$1 = cljs.core.next.call(null,seq23116);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23117,seq23116__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__23127__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__23127__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__23127__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__23127__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__23128 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__23128,(0),null);
var fn_name = cljs.core.nth.call(null,vec__23128,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__23128,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__23128,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__23128,(4),null);
var arity = cljs.core.nth.call(null,vec__23128,(5),null);
...
var o__22403__auto__ = f;
return (o__22403__auto__["getBasis"]).call(o__22403__auto__);
});
/**
...
}catch (e23132){var _e__22410__auto__ = e23132;
...
var G__23133 = (obj[cljs.core.first.call(null,path)]);
var G__23134 = cljs.core.rest.call(null,path);
obj = G__23133;
path = G__23134;
continue;
} else {
...
var _STAR_ = (function (accum,p__23135){
var vec__23136 = p__23135;
var bit = cljs.core.nth.call(null,vec__23136,(0),null);
var protocol = cljs.core.nth.call(null,vec__23136,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__23139){
var vec__23140 = p__23139;
var ns = cljs.core.nth.call(null,vec__23140,(0),null);
var name = cljs.core.nth.call(null,vec__23140,(1),null);
var selector = cljs.core.nth.call(null,vec__23140,(2),null);
...
var post_process = (function (p__23144){
var vec__23145 = p__23144;
var munged_name = cljs.core.nth.call(null,vec__23145,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__23145,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__23143_SHARP_){
return (obj[cljs.core.first.call(null,p1__23143_SHARP_)]);
}),sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1595490052293
