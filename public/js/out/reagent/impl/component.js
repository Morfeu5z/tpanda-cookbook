...
if((i < len)){
var k = (ks[i]);
var G__25403 = cljs.core.assoc.call(null,m,cljs.core.keyword.call(null,k),goog.object.get(o,k));
var G__25404 = (i + (1));
m = G__25403;
i = G__25404;
continue;
...
return ((cljs.core.fn_QMARK_.call(null,c)) && ((!(((function (){var G__25406 = c;
var G__25406__$1 = (((G__25406 == null))?null:G__25406.prototype);
if((G__25406__$1 == null)){
return null;
} else {
return G__25406__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_.call(null,c)) && ((!(((function (){var G__25408 = c;
var G__25408__$1 = (((G__25408 == null))?null:G__25408.prototype);
if((G__25408__$1 == null)){
return null;
} else {
return G__25408__$1.render;
}
})() == null)))));
});
...
return (function() { 
var G__25411__delegate = function (args){
...
while (G__25412__i < G__25412__a.length) {G__25412__a[G__25412__i] = arguments[G__25412__i + 0]; ++G__25412__i;}
  args = new cljs.core.IndexedSeq(G__25412__a,0,null);
} 
...
var args = cljs.core.seq(arglist__25413);
...
var G__25415 = c;
var G__25415__$1 = (((G__25415 == null))?null:G__25415.constructor);
if((G__25415__$1 == null)){
return null;
} else {
return G__25415__$1.displayName;
}
});
...
var _STAR_current_component_STAR__orig_val__25416 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__25417 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__25417);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__25416);
}});
...
var c = this;
var G__25421_25423 = goog.object.get(c,"cljsRatom");
if((G__25421_25423 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__25421_25423);
}
...
var renders_25424 = cljs.core.select_keys.call(null,fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_25425 = cljs.core.first.call(null,cljs.core.vals.call(null,renders_25424));
...
if((cljs.core.count.call(null,renders_25424) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count.call(null,renders_25424))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_.call(null,render_fun_25425)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.call(null,render_fun_25425)].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__25426 = o;
goog.object.set(G__25426,cljs.core.name.call(null,k),v);
...
//# sourceMappingURL=component.js.map?rel=1595490055781
