...
return (new CustomEvent(event_name,(function (){var obj29396 = ({"detail":data});
return obj29396;
})()));
} else {
...
var f = (function (){var pred__29403 = cljs.core._EQ_;
var expr__29404 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__29403.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__29404))){
return (function (p1__29397_SHARP_){
return console.warn(p1__29397_SHARP_);
});
} else {
if(cljs.core.truth_(pred__29403.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__29404))){
return (function (p1__29398_SHARP_){
return console.debug(p1__29398_SHARP_);
});
} else {
if(cljs.core.truth_(pred__29403.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__29404))){
return (function (p1__29399_SHARP_){
return console.error(p1__29399_SHARP_);
});
} else {
return (function (p1__29400_SHARP_){
return console.log(p1__29400_SHARP_);
});
}
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__29407){
...
var eval_fn = cljs.core.get.call(null,map__29408__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
f.call(null,val,(function (p1__29410_SHARP_){
return new_def.callback(p1__29410_SHARP_);
}));
...
return cljs.core.mapv.call(null,(function (p__29411){
var vec__29412 = p__29411;
var ky = cljs.core.nth.call(null,vec__29412,(0),null);
var v = cljs.core.nth.call(null,vec__29412,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1595490058944
